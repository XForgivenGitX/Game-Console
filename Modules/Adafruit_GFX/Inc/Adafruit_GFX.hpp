...
void tft_drawBitmap_01(int16_t x, int16_t y, const uint8_t *bitmap,int16_t w, int16_t h, uint16_t color, uint16_t bg);
void tft_drawBitmap_02(int16_t x, int16_t y, uint8_t *bitmap,int16_t w, int16_t h, uint16_t color);
void tft_drawBitmap_03(int16_t x, int16_t y, uint8_t *bitmap,int16_t w, int16_t h, uint16_t color, uint16_t bg);
...
void tft_setTextColor_01(uint16_t c, uint16_t bg);
